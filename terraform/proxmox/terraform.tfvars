...
proxmox_image         = "talos161"                  # talos image created by packer
talos_version         = "v1.6.1"                   # talos version for machineconfig gen
cluster_endpoint      = "https://home-cluster.f-wi.com:6443" # cluster endpoint to fetch via talosctl
...
kubernetes = {
  ...
  apiDomain               = "home-cluster.f-wi.com"   # cluster endpoint
  talos-version           = "v1.6.1"              # talos installer version
